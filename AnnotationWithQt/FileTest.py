...
# Form implementation generated from reading ui file 'FileTest.ui'
#
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(20, 40, 800, 600))
        self.label.setStyleSheet("background-color: rgb(255, 255, 255);")
        self.label.setObjectName("label")
        self.pushButton = QtWidgets.QPushButton(self.centralwidget)
        self.pushButton.setGeometry(QtCore.QRect(70, 670, 141, 41))
        font = QtGui.QFont()
        font.setFamily("楷体")
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(310, 670, 141, 41))
        font = QtGui.QFont()
        font.setFamily("楷体")
        font.setPointSize(12)
